  ...
  return (
    <main>
      ...
      <Container card={true} className="card-text">
        <p>
          Handbal is een complete en leuke sport voor kinderen die van balsporten houden en graag in
          teamverband spelen. Het spel gaat snel en er wordt veel gescoord: ook als toeschouwer is
          dit aangenaam om volgen!
        </p>
        <p>
      ...
      <Container card={true} className="card-text">
        ...
        <p>
          ...
          SASJA uit 2 delen: het deel van Jespo om buiten de schooluren tweemaal per week te kunnen
          sporten bij een erkende sportclub en het deel van SASJA voor een derde training en om in
          het weekend deel te kunnen nemen aan competitiewedstrijden.
        </p>
      </Container>
      ...
      <Container card={true} className="card-text">
        ...
        <p>
          Naargelang de leeftijd bedraagt het inschrijvingsgeld 60 of 110 EUR (1 of 2 trainingen per
          week)
        </p>
        <p>
          Als je lid bent van Jespo mag je deelnemen aan de trainingen en ben je volledig verzekerd
          tegen eventuele blessures of ongevallen tijdens deze trainingen. Meer informatie vind je
          in de algemene voorwaarden van Jespo.
        </p>
      </Container>
      ...
      <Container card={true} className="card-text">
        ...
        <p>
          Bovendien krijg je een kledingpakket waarvoor je na inschrijving gecontacteerd zal worden
          om je maten door te geven.
        </p>
        <p>
          ...
          <a href="mailto:secretariaat@sasja-antwerpen.be">secretariaat@sasja-antwerpen.be</a>. Als
          het niet anders kan, mag je het ook aan de trainer/coach afgeven. Hierna krijg je per
          e-mail verdere instructies, zoals o.m. de uitnodiging om het lidgeld te betalen.
        </p>
      </Container>
