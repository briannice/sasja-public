    ...
    <>
      ...
      <main>
        ...
        <Container card={true} className="card-text">
          ...
          <p>
            Ben jij op zoek naar een leuke en energieke manier om actief te blijven en nieuwe
            vrienden te maken?{' '}
          </p>
          <p>Zoek niet verder! Onze recreantenploeg heet jou van harte welkom!</p>
          <h2>Doe Vandaag Nog Mee!</h2>
          <p>
            Of je nu een oud-handbalprof bent of gewoon nieuwsgierig bent naar deze geweldige sport,
            onze recreantenploeg staat open voor iedereen die wil deelnemen:{' '}
            <a href="mailto:recreanten@sasja-antwerpen.be">meld je aan</a> en ontdek de sfeer, het
            plezier en de vriendschap binnen het handbal.
          </p>
